...
public class NBTSkriptListCheck extends SimpleExpression<Boolean> {

    static {
        Skript.registerExpression(NBTSkriptListCheck.class, Boolean.class, ExpressionType.SIMPLE,
                "nbt list named %string% of %itemstack%");
    }
    ...
    public String toString(@Nullable Event e, boolean debug) {
        return "nbt list named " + this.name.getSingle(e) + " of " + this.item.getSingle(e);
    }
