...
public class NBTSkriptListLoad extends SimpleExpression<String> {

    static {
        Skript.registerExpression(NBTSkriptListLoad.class, String.class, ExpressionType.SIMPLE,
                "load nbt list named %string% of %itemstack%");
    }
    ...
    public String toString(@Nullable Event e, boolean debug) {
        return "load nbt list named " + this.name.getSingle(e) + " of " + this.item.getSingle(e);
    }
